...
* Do you think it would be easier or harder to search through this data manually or using SQL? Easier 
* What about when the dataset gets larger? It is easier to use SQL queries. 
